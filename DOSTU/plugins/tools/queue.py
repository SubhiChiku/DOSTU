...
from DOSTU.utils import DOSTUBin, get_channeplayCB, seconds_to_min
from DOSTU.utils.database import get_cmode, is_active_chat, is_music_playing
from DOSTU.utils.decorators.language import language, languageCB
from DOSTU.utils.inline import queue_back_markup, queue_markup
